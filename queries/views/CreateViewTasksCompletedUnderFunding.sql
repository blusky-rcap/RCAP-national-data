...
CREATE OR ALTER VIEW dbo.vw_CompletedUnderFunding
AS
...
JOIN dbo.Project_X_Task pxt ON pxt.ProjectId = p.Id AND pxt.TaskStatus = 'Completed' AND pxt.EndDate BETWEEN pfh.sDate AND pfh.eDate
